...
topic: nexl-builder 三平台识别与路由机制 —— 一句固定激活语如何让 Agent 在 Coze / Meoo / WorkBuddy 上自识别、加载对应规则、校验时效并服务建站
---
...
1. **通用激活语固定那一句**（Coze / Meoo / WorkBuddy 三平台）。不为任何平台改文案、不加平台后缀。可移植性 = 一切。
